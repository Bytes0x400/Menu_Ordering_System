        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in submenu_items.keys():
                    ...
                    #Using list comprehension to create the Price_total list
                    Price_total = [round(item["Quantity"] * item["Price"],2) for i, item in enumerate(order_list,1)]
...
if len(order_list) > 0:
    ...
    if qty_total > 9:
        ...
        pre_qty_space = ' '*4
        post_qty_space = ' '*5
    #printing out the 4 columns - col1 for Item name, col2 for Unite Pric, col3 for Quantity and col4 for Price
